...
class XG_Validator(Executor):
    ...
    def execute(self, task_name: str, shareable: Shareable, dxo: DXO, fl_ctx: FLContext, abort_signal: Signal) -> Shareable:
        ...
        self.log_info(fl_ctx, f"DXO12321: \n{dxo}")
